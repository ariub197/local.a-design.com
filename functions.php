...
function my_script_init() {
  ...
  wp_enqueue_script("my-script", get_template_directory_uri() . "/src/assets/js/concat.js", array("jquery"), filemtime(get_theme_file_path('/src/assets/js/concat.js')), true);
}
