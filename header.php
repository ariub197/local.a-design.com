  ...
  <header id="header">
    <div class="l-header">
      <div class="l-header__pc">
        <h1 class="l-header__logo"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/logo_design.svg" alt="Arisumi Design logo"></a>
        </h1>
        ...
        <div class="l-header__contact"><a href="/contact/" class="c-contact-button u-desvg">
          <img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/email.svg" alt="" width="32" height="24">お問い合わせ</a>
        </div>
      </div>
    </div>
    <div class="l-header__sp">
      <h1 class="l-header__logo-sp"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/logo_design.svg" alt="Arisumi Design logo"></a>
      </h1>
      <div class="l-header__contact-sp">
        <a href="/contact/" class="c-contact-button__sp u-desvg"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/email.svg" alt="" width="32" height="24"></a>
      </div>
    </div>
    ...
    <div class="c-drawer-content">
      ...
      <div class="l-drawer__contact-sp"><a href="/contact/" class="c-contact-button u-desvg">
        <img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/email.svg" alt="" width="32" height="24">お問い合わせ</a></div>
    </div>
  </header>
  <main>