  ...
  <header id="header">
    <div class="l-header">
      <div class="l-header__pc">
        <h1 class="l-header__logo"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/Logo Design.svg" alt="Arisumi Design logo"></a>
        </h1>
        ...
        <div class="c-header__sns-links">
          <div class="c-header__sns-link"><a href="https://twitter.com/ari19702" class="c-header__sns-link--twitter"><i class="fa-brands fa-twitter"></i></a></div>
    ...
    <div class="l-header__sp">
      <h1 class="l-header__logo-sp"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/Logo Design.svg" alt="Arisumi Design logo"></a>
      </h1>
      <div class="l-header__contact-sp"><a href="/contact/" class="c-contact-button__sp u-desvg">
